...
The original app was published on the iOS App Store, received multiple updates, and served real users and paying subscribers. This repository presents the application source; running all features requires your own backend and native app configuration. AI features integrate an external multimodal model.
...
Screenshots of the home screen, outfit analysis and virtual wardrobe will be added here using sample data.
